...
from jouzetsu.web.icon import FALLBACK_ICON_FILENAME, ICON_FILENAME, configured_icon_svg, icon_artwork_path


def test_icon_artwork_path_uses_release_safe_fallback_when_private_icon_is_missing(tmp_path: Path) -> None:
...
def test_fallback_icon_uses_the_configured_palette() -> None:
    ...
    svg: str = configured_icon_svg(
        ...
        IconColorSettings(linework_color="#112233", accent_color="#445566", surface_color="#778899"),
    )
